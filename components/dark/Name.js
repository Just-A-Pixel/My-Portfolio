...
const Name = () => {
  return (
    ...
    <motion.div initial={{opacity: 0}} animate = {{opacity: 1}} transition = {{duration: 0.5, delay: 1.7}} className={styles.dark__name}>
      ...
      <br/>
      <motion.h6 initial={{opacity: 0}} animate = {{opacity: 1}} transition = {{duration: 0.5, delay: 2.3}} className={`${styles.neonText} ${styles.pulsate} ${styles.flicker3}`} style={{fontSize: '20px', textAlign: 'left', position: 'absolute'}}>FullStack Developer</motion.h6>
